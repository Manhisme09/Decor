<div class="modal fade" id="modal_order_view" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h4 style="margin-left: 30px;">Tên người nhận: <span id="khach_hang"></span></h4>
