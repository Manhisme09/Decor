...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="{{ route('admin.nhanvien.postSua', ['id' => $users->id]) }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ho_ten" placeholder="Họ và tên" name="ho_ten"
                        value="{{ $users->admin->ho_ten }}" autocomplete="off" />
                    @error('ho_ten')
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="Email" name="email"
                        value="{{ $users->email }}" autocomplete="off" disabled />
                    @error('email')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dien_thoai" placeholder="Số điện thoại" name="dien_thoai"
                        value="{{ $users->admin->dien_thoai }}" autocomplete="off" />
                    @error('dien_thoai')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group" style="width: 40%;">
                    ...
                    <input type="date" class="form-control" id="ngay_sinh" name="ngay_sinh"
                        value="{{ $users->admin->ngay_sinh }}" autocomplete="off" />
                    @error('ngay_sinh')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group" style="width: 40%;">
                    ...
                    <select class="form-control" name="gioi_tinh" id="gioi_tinh">
                        ...
                        <option value="Nữ" @if ($users->admin->gioi_tinh == 'Nữ') selected @endif>Nữ</option>
                    </select>
                    @error('gioi_tinh')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dia_chi" name="dia_chi"
                        value="{{ $users->admin->dia_chi }}" placeholder="Địa chỉ" />
                    @error('dia_chi')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="{{ route('admin.nhanvien.resetPass', ['id' => $users->id]) }}" method="POST">
                @csrf
