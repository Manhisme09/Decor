...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="{{ route('admin.voucher.postSua', ['id'=>$voucher->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Mã phiếu giảm giá" name="ma_giam_gia"
                        autocomplete="off" value="{{ $voucher->ma_giam_gia }}" />
                    @error('ma_giam_gia')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Số tiền giảm" name="so_tien"
                        autocomplete="off" value="{{ $voucher->gia_tien }}" />
                    @error('so_tien')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Số lượng phiếu giảm giá" name="so_luong"
                        autocomplete="off" value="{{ $voucher->so_luong }}" />
                    @error('so_luong')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Ngày bắt đầu" name="ngay_bat_dau"
                        autocomplete="off" value="{{ $voucher->ngay_bat_dau }}" />
                    @error('ngay_bat_dau')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Ngày kết thúc" name="ngay_ket_thuc"
                        autocomplete="off" value="{{ $voucher->ngay_ket_thuc }}" />
                    @error('ngay_ket_thuc')
                        <p style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                <a type="button" href="" class="btn btn-success" value="quay lại">Quay
                    lại</a>
